...
$002C	$0008			RETURN
$0004	$	_main:
;Pic1.pbas,1 :: 		program Pic1
$0004	$	_main_main:
;Pic1.pbas,3 :: 		inicio:
$0004	$	_main_inicio:
;Pic1.pbas,4 :: 		TRISA=%11111111
$0004	$30FF			MOVLW	255
$0005	$1303			BCF	STATUS, RP1
$0006	$1683			BSF	STATUS, RP0
$0007	$0085			MOVWF	TRISA
;Pic1.pbas,5 :: 		TRISB=%11111111
$0008	$30FF			MOVLW	255
$0009	$0086			MOVWF	TRISB
;Pic1.pbas,6 :: 		TRISC=%00000000
$000A	$0187			CLRF	TRISC, 1
;Pic1.pbas,7 :: 		INTCON=%00000000
$000B	$018B			CLRF	INTCON, 1
;Pic1.pbas,8 :: 		ANSEL=%00000000
$000C	$1703			BSF	STATUS, RP1
$000D	$1283			BCF	STATUS, RP0
$000E	$019E			CLRF	ANSEL, 1
;Pic1.pbas,9 :: 		ANSELH=%00000000
$000F	$019F			CLRF	ANSELH, 1
;Pic1.pbas,11 :: 		Usart_Init(9600)
$0010	$3019			MOVLW	25
...
;Pic1.pbas,13 :: 		executa:
$0016	$	_main_executa:
;Pic1.pbas,15 :: 		goto executa
